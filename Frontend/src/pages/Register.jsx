            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="text-gray-700 input-field mt-1"
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="text-gray-700 input-field pr-10"
                    placeholder="Enter your password (min. 6 characters)"
                  />
                  <button
                    type="button"
                    className=" text-gray-700 absolute inset-y-0 right-0 pr-3 flex items-center"
